...
pdf("oncoplot_sencillo_PAAD.pdf", width=20, height=10)
oncoplot(maf = PAAD, genes = c("TP53","KRAS","CDKN2A.p16INK4a","CDKN2A.p14arf","SMAD4", "RNF43", "ARID1A"))
dev.off()

pdf("oncoplot_con_titv_PAAD.pdf", width=20, height=10)
oncoplot(maf = PAAD, genes = c("TP53","KRAS","CDKN2A.p16INK4a","CDKN2A.p14arf","SMAD4", "RNF43", "ARID1A"), draw_titv= TRUE)
dev.off()

pdf("oncoplot_vias_PAAD.pdf", width=20, height=10)
